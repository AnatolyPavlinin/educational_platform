...
class PaymentFilter(django_filters.FilterSet):
    ...
    method = django_filters.ChoiceFilter(choices=Payment._meta.get_field('method').choices)

    # Фильтры по ID связанного объекта
    course = django_filters.UUIDFilter(field_name='object_id', method='filter_by_course')
    lesson = django_filters.UUIDFilter(field_name='object_id', method='filter_by_lesson')
